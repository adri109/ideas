# Plantillas del sprint de validación

Material para ejecutar el [sprint de 14 días](../docs/10-siguiente-paso.md). Están en el orden
en que se usan; no hace falta leerlas todas de golpe.

| Cuándo | Plantilla | Para qué |
|---|---|---|
| Días 1-2 | [00 · Selección de vertical](00-seleccion-de-vertical.md) | Puntuar tres candidatos, decidir uno y construir la lista de 60 negocios |
| Días 1-5 | [01 · Auditoría encubierta](01-auditoria-encubierta.csv) | Registrar los 60 negocios y el resultado de las 40 pruebas de contacto |
| Días 6-10 | [02 · Guion de entrevista](02-guion-entrevista.md) | Las 14 preguntas, en orden, y cómo interpretar las respuestas |
| Días 6-14 | [03 · Mensajes de contacto](03-mensajes-de-contacto.md) | Pedir entrevista, usar la evidencia, activar tu red, cerrar el piloto |
...
1. **Cero código durante el sprint.** La demo se monta con herramientas de terceros. Escribir
   ...
   incómoda.
2. **Los números se miden, no se estiman.** Especialmente el coste por minuto de voz, que es
